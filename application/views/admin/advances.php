...
<script type="text/javascript">
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return '<a style="text-decoration:none" class="ml-5" onclick="check(' + full.DebitId + ')" href="javascript:;" title="审核"><i class="Hui-iconfont">&#xe6df;Audit</i></a>';
                }
            }
        ],
    ...
    function check(id) {
        layer_show('Audit', "<?=site_url('admin/advancesCheck/')?>" + id, null, null);
    }
    ...
    function export1() {
        ...
        location.href = "<?=site_url('admin/export4')?>" + '?start_time=' + startTime + '&end_time=' + endTime;
    }
</script>
<!--/请在上方写此页面业务相关的脚本-->
