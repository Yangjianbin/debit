...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form">
        ...
        <div class="row cl">
            <label class="form-label col-xs-2 col-sm-2">Fee：</label>
            <div class="formControls col-xs-4 col-sm-4" >
                <input type="text" class="input-text" style="color:red" value="<?= $item->fee ?>" placeholder="">
            </div>

            <label class="form-label col-xs-2 col-sm-2">Pay applicant：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" style="color:red" value="<?= $item->DebitMoney -  $item->fee?>" placeholder="">
            </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-2 col-sm-2">Image Uplaod：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <div class="uploader-thum-container">
                    <div id="fileList" class="uploader-list"></div>
                    <div id="filePicker">Choose Image</div>
        ...
        <div class="row cl" id="reason">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                ...
                <select class="select check-item" style="width:200px;">
                    ...
                    <option value="Bank Information Incorrect">Bank Information Incorrect</option>
    ...
    $(function () {
        ...
        $('#submit').click(function () {
            layer.confirm('Confirm of Approval？', {
                ...
                if (obj.status == -1 && !obj.description) {
                    layer.msg('备注必须填写');
                    return;
                }
                $.ajax({
                    url: "<?=site_url('admin/doAdvances')?>",
                    type: 'post',
                    dataType: 'json',
                    data: obj
                }).done(function (res) {
