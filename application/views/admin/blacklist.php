...
<!--                </div>-->
                ...
                <span class="l pd-5">
                    <input type="text" placeholder="UserId" id="user" style="width: 200px;"
                           class="input-text"/>
...
<script type="text/javascript">
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return '<a style="text-decoration:none" class="ml-5" onclick="check(' + full.UserId + ')" href="javascript:;" title="解除"><i class="Hui-iconfont">&#xe6df;Remove</i></a>';
                }
            }
        ],
    ...
    function check(id) {
        layer.confirm('Confirm of Remove？', {
            ...
            $.ajax({
                url: "<?=site_url('admin/removeBlacklist/')?>" + id,
                type: 'get',
                dataType: 'json'
            }).done(function (res) {
                console.log(res)
    ...
    function addBlack() {
        ...
        layer.confirm('Confirm of Add？', {
            ...
            $.ajax({
                url: "<?=site_url('admin/addBlacklist/')?>" + id,
                type: 'get',
                dataType: 'json'
            }).done(function (res) {
                console.log(res)
