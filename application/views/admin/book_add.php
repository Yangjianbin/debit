...
<style>
    ...
    ul.ztree {overflow: scroll; z-index:9999;margin-top: 10px;border: 1px solid #617775;background: #f0f6e4;width:220px;height:360px;overflow-y:scroll;overflow-x:auto;}
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <input type="text" class="input-text" value="" placeholder="可模糊查询" id="title" name="publisher">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">出版时间：</label>
            <div class="formControls col-xs-8 col-sm-10">
                <input type="text" name="publish_time" style="width: 200px;" onfocus="WdatePicker()"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <input type="text" class="input-text" value="" placeholder="" id="title" name="isbn">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">分类：</label>
            <div class="formControls col-xs-8 col-sm-10">
                <input id="citySel" type="text" class="input-text" readonly onclick="showMenu();"  style="width: 90%">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <div id="container2">
                    ...
                    <input type="text" class="input-text" placeholder="" style="width: 80%;" name="save_path">
                </div>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <input type="text" class="input-text" value="" placeholder="下载地址和密码之间用@隔开 例如 http://pan.baidu.com@ABCD" style="width: 100%;margin-bottom: 5px;"
                       name="download_links[]">
                <input type="text" class="input-text" value="" placeholder="" style="width: 100%;margin-bottom: 5px;"
                       name="download_links[]">
                <input type="text" class="input-text" value="" placeholder="" style="width: 100%;margin-bottom: 5px;"
                       name="download_links[]">
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <input type="text" style="width:100%;margin-bottom: 5px;" class="input-text" value="" placeholder="网站和地址之间用@隔开 例如 京东@http://www.jd.com"  name="buy_links[]">
                <input type="text" style="width:100%;margin-bottom: 5px;" class="input-text" value="" placeholder=""  name="buy_links[]">
                <input type="text" style="width:100%;" class="input-text" value="" placeholder=""  name="buy_links[]">
            </div>
        </div>
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button id="addArticle" type="button" class="btn btn-primary radius"><i class="Hui-iconfont">
                        &#xe632;</i> 点击上架
                </button>
            </div>
        </div>
