            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tr class="text-c">
                        <th>Register No.</th>
                        <th>New Added No.</th>
                        <th>Loan Approval No.</th>
                        <th>New Added Approval No. </th>
                        <th>Loan Paid No.</th>
                        <th>New Added Loan Paid No.</th>
                        <th>Unpass NO.</th>
                        <th>New Added Upass No.</th>
                        <th>Payback No.</th>
                        <th>New Added Payback</th>
                        <th>Extend No.</th>
                        <th>New Added Extend</th>
                        <th>操作</th>
                    </tr>
                    </thead>
                </table>
...
//            $(row).children('td').eq(0).attr('style', 'text-align: center;')
    ...
    function export1() {
        ...
        location.href = "<?=site_url('admin/export1')?>" + '?start_time=' + startTime + '&end_time=' + endTime;
    }
