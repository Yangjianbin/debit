...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form">
        ...
        <?php if($item->duextend):?>
        <?php endif; ?>
        <div class="row cl">
            <label class="form-label col-xs-2 col-sm-2">Money：</label>
            <div class="formControls col-xs-4 col-sm-4">
...
<!--            </div>-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                ...
                <div class="radio-box">
                    <input type="radio" id="sex-2" value="7" name="status" checked>
        ...
        <div class="row cl" id="reason">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                ...
                <select class="select check-item" style="width:200px;">
                    ...
                    <option value="Can't extend">Can't extend</option>
                    <option value="Can't extend again">Can't extend again</option>
                </select>
                </span>
            </div>
        </div>
    ...
    $(function () {
        ...
        $('#submit').click(function () {
            layer.confirm('Confirm of Approval？', {
                ...
                if (obj.status == 7 && !obj.description) {
                    layer.msg('备注必须填写');
                    return;
                }
                $.ajax({
                    url: "<?=site_url('admin/doDuextend')?>",
                    type: 'post',
                    dataType: 'json',
                    data: obj
                }).done(function (res) {
