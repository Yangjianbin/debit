            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <th>Received capital ratio</th>
                        <th>Received interests</th>
                        <th>Received revenue</th>
                        <th>Reccived revenue ratio</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    var table = $('.table-sort').dataTable({
        ...
        "aoColumnDefs": [],
        ajax: "<?=site_url('export/monthoverdue')?>",
        columns: [
            {data: "month"},
            {data: "overdueDebitCount"},
            {data: "shouldPaybackMoney","render":function (data) {
                    return number(data / 10000);
                }},
            {data: "alreadyPaybackMoney","render":function (data) {
                    return number(data / 10000);
                }},
            {data: "alreadyPaybackMoney", "render": function ( data,type,all) {
                    var str = 100 * all.alreadyPaybackMoney / all.shouldPaybackMoney;
                    return str.toFixed(2) + '%';
                }},
            {data: "alreadyPayInterest","render":function (data) {
                    return number(data / 10000);
                }},
            {data: "alreadyBackTotalMoney","render":function (data) {
                    return number(data / 10000);
                }},
            {data: "alreadyBackTotalMoney", "render": function ( data,type,all) {
                    var str = 100 * all.alreadyBackTotalMoney / all.shouldPaybackMoney;
                    return str.toFixed(2) + '%';
                }}
        ],
