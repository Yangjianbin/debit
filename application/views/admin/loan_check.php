...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form">
        ...
        <div class="row cl">
            ...
            <label class="form-label col-xs-2 col-sm-2">Star：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <?php if($item->user->redStar > 0):?>
                    <div style="width: 24px;height:24px;background:  red;float: left;margin-right: 10px;"></div>
                <?php endif;?>
                <?php if($item->user->blackStar > 0):?>
                    <div style="width: 24px;height:24px;background:  black;float: left;margin-right: 10px;"></div>
                <?php endif;?>
                <?php if($item->user->greenStar > 0):?>
                    <div style="width: 24px;height:24px;background:   green;float: left;margin-right: 10px;"></div>
                <?php endif;?>
        ...
        <div class="row cl" id="reason">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                ...
                <select class="select check-item" style="width:200px;">
                    ...
                    <option value="Info Bank salah">nfo Bank salah</option>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">Note：If upass,must be filled in reason for not pass：</label>
