...
<script type="text/javascript">
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return '<a style="text-decoration:none" class="ml-5" onclick="check(' + full.Id + ')" href="javascript:;" title="审核"><i class="Hui-iconfont">&#xe6df;Edit</i></a>';
                }
            }
        ],
    ...
    function check(id) {
        layer_show('Edit', "<?=site_url('admin/noticeEdit/')?>" + id, null, null);
    }
