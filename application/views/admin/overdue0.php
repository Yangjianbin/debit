    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                ...
                <div class="l pd-5">
                    <input type="text" placeholder="Payback time" id="payback_time_start" style="width: 200px;" onfocus="WdatePicker()"
                           class="input-text Wdate"/>
                    -
                    <input type="text" placeholder="Payback time" id="payback_time_end" style="width: 200px;" onfocus="WdatePicker()"
                           class="input-text Wdate"/>
                </div>
...
<script type="text/javascript">
    ...
    var table = $('.table-sort').dataTable({
        ...
        fnServerParams: function (aoData) {
            ...
            aoData.paybackTimeStart = $('#payback_time_start').val();
            aoData.paybackTimeEnd = $('#payback_time_end').val();
        },
        ...
        columns: [
            ...
            {data: "description",render:function (val,type,full) {
                    var desc = full.description,s = full.auditStatus;
                    var str = '';
                    if(desc == 1){
                        str += 'Apply for loan';
                    } else if(desc == 2){
                        str += 'Repayment has been applied'
                    } else if(desc == 3){
                        str += 'Repayment has been approved'
                    } else if(desc == 4){
                        str += 'Overdue'
                    } else if(desc == 5){
                        str += 'Approved(Non lending)'
                    } else if(desc == 6){
                        str += 'Extend'
                    }
                    if(s == 1){
