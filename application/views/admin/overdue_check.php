        ...
        <div class="row cl" id="reason">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                ...
                <select class="select check-item" style="width:200px;">
                    ...
                    <option value="User Information Incorrect">User Information Incorrect</option>
                    <option value="Bank Information Incorrect">Bank Information Incorrect</option>
                    <option value="Work Information Incorrect">Work Information Incorrect</option>
                    <option value="ID Information Incorrect">ID Information Incorrect</option>
                    <option value="Contact Information Incorrect">Contact Information Incorrect</option>
                </select>
                </span>
            </div>
        </div>
