...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <nav class="breadcrumb"><i class="Hui-iconfont"></i> Loan Mgr
            <span class="c-gray en">&gt;</span>
            Payback Mgr
            <span class="c-gray en">&gt;</span>
            List  </nav>
                ...
                <span class="l pd-5">
                    <span class="select-box inline">
                        <select id="status" class="select">
                            ...
                            <option selected value="3">Repayment has been approved</option>
                        </select>
                    </span>
...
<script type="text/javascript">
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return '<a style="text-decoration:none" class="ml-5" onclick="check(' + full.DebitId + ')" href="javascript:;" title="确认还款"><i class="Hui-iconfont">&#xe6df;View</i></a>';
                }
            }
        ],
    ...
    function check(id) {
        layer_show('Audit', "<?=site_url('admin/paybackedCheck/')?>" + id, null, null);
    }
