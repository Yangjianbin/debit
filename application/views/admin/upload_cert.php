...
<!--                <div class="l pd-5">-->
<!--                    <input type="text" placeholder="Approval Time" id="start_time" style="width: 200px;" onfocus="WdatePicker()"-->
<!--                           class="input-text Wdate"/>-->
<!--                    --->
<!--                    <input type="text" placeholder="Approval Time" id="end_time" style="width: 200px;" onfocus="WdatePicker()"-->
<!--                           class="input-text Wdate"/>-->
<!--                </div>-->
...
<!--                            <option selected value="5">Approved(Non lending)</option>-->
<!--                            <option value="1">Approved(Already released)</option>-->
<!--                        </select>-->
<!--                    </span>-->
...
<script type="text/javascript">
    ...
    var table = $('.table-sort').dataTable({
        ...
        "aoColumnDefs": [],
        ajax: "<?=site_url('admin/uploadCert')?>",
        columns: [
            {data: "DebitId"},
            // {data: "DebitMoney"},
            // {data: "DebitPeroid"},
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    var str = '<a style="text-decoration:none" class="ml-5" onclick="check(' + full.DebitId + ')" href="javascript:;" title="审核"><i class="Hui-iconfont">&#xe6df;View</i></a>';

                    return str + '<a style="text-decoration:none" class="ml-5" onclick="uploadcert(' + full.DebitId + ')" href="javascript:;" title="Upload"><i class="Hui-iconfont">&#xe6df;Upload Cert</i></a>';
                }
            }
        ],
    ...
    function uploadcert(id) {
        ...
        layer_show('View', "<?=site_url('admin/uploadCertCheck/')?>" + id, null, null);
    }
