...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form">
        <input type="hidden" name="debitId" value="<?= $id ?>"/>
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3">Loan Reference No.：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" readonly value="<?= $id ?>" placeholder="">
            </div>
        </div>

        <div class="row cl" id="reason">
            <label class="form-label col-xs-2 col-sm-3">Type：</label>
            <div class="formControls col-xs-8 col-sm-3">
                <span class="select-box inline">
                <select name="type" class="select check-item" style="width:200px;">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3">Image Uplaod：</label>
            <div class="formControls col-xs-4 col-sm-4">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#submit').click(function () {
            layer.confirm('Confirm of Upload？', {
                btn: ['YES', 'NO'],
                title: 'UploadCert',
                icon: 3
            }, function () {
                ...
                $.ajax({
                    url: "<?=site_url('admin/doUploadCert')?>",
                    type: 'post',
                    dataType: 'json',
                    data: obj
                }).done(function (res) {
