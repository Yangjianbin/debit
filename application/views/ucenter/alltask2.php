    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                ...
                <div class="l pd-5">
                    <input type="text" placeholder="Payback Time" id="start_time" style="width: 200px;"
                           onfocus="WdatePicker()"
                           class="input-text Wdate"/>
                    -
                    <input type="text" placeholder="Payback Time" id="end_time" style="width: 200px;"
                           onfocus="WdatePicker()"
                           class="input-text Wdate"/>
                </div>
...
<script type="text/javascript">
    ...
    var table = $('.table-sort').dataTable({
        ...
        "aoColumnDefs": [],
        ajax: "<?=site_url('ucenter/alltask2')?>",
        columns: [
            {data: "DebitId"},
            // {data: "DebitMoney"},
            // {data: "DebitPeroid"},
